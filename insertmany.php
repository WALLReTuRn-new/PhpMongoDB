...
class index {
    ...
    //Here no used MongoDb Just repeat InserOne
    public function insert() {
        ...
        $inserts = [
            [
                'title' => 'MongoDb21321321',
                'qty' => 30,
                'description' => '22222'
            ],
            [
                'title' => 'MongoDb312321312',
                'qty' => 30,
                'description' => '22222'
            ],
            [
                'title' => 'MongoDb31231231221',
                'qty' => 30,
                'description' => '22222'
            ]
        ];
        ...
        foreach ($inserts as $insert):
            $lastinser = $this->registry->MongoDb->insert('testdb', $insert);
        endforeach;
